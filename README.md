...
|---------|:-----:|-------------|
| [NanoCoder](https://github.com/he-yufeng/NanoCoder) | 265+ | 512K lines of Claude Code → 1,300 lines of Python. Every key architectural pattern, runnable. Any LLM. |
...
| 项目 | Stars | 简介 |
|------|:-----:|------|
| [NanoCoder](https://github.com/he-yufeng/NanoCoder) | 265+ | Claude Code 51万行源码 → 1300行 Python 核心重写，支持任意大模型，附 7 篇架构导读 |
