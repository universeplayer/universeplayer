...
| [FindJobs-Agent](https://github.com/he-yufeng/FindJobs-Agent) | 96+ | LLM-powered job toolkit: skill gap analysis, mock interviews, resume optimization |
...
| [ContractGuard](https://github.com/he-yufeng/ContractGuard) | 43+ | AI agent that reviews contracts for red flags before you sign |
...
| [GitSense](https://github.com/he-yufeng/GitSense) | 12+ | AI-powered open source contribution finder, tell it your skills, it finds issues |
| [RuleForge](https://github.com/he-yufeng/RuleForge) | 9+ | Auto-generate AI assistant rules (CLAUDE.md, .cursorrules) from codebase analysis |
| [BatchLLM](https://github.com/he-yufeng/BatchLLM) | 6+ | Batch LLM processing: CSV in, processed CSV out, with retries and cost tracking |
...
| [FindJobs-Agent](https://github.com/he-yufeng/FindJobs-Agent) | 96+ | LLM 求职工具箱：技能差距分析、模拟面试、简历优化 |
...
| [ContractGuard](https://github.com/he-yufeng/ContractGuard) | 43+ | AI 合同审查 Agent，签字前帮你找出霸王条款 |
...
| [GitSense](https://github.com/he-yufeng/GitSense) | 12+ | AI 驱动的开源贡献发现器，输入技能自动找 issue |
| [RuleForge](https://github.com/he-yufeng/RuleForge) | 9+ | 从代码库自动生成 AI 助手规则（CLAUDE.md、.cursorrules）|
| [BatchLLM](https://github.com/he-yufeng/BatchLLM) | 6+ | LLM 批量处理：CSV 进 CSV 出，自动重试 + 费用追踪 |
